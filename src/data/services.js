const data = [
  ...
  mainBenefitsbullet2: "Resistant to dirt in challenging environments",
    ...
    mainBenefitsnetwork1: "Clear recording in low light",
    mainBenefitsnetwork2: "They usually record in both color and black and white",
    mainBenefitsnetwork3: "Can function despite glare, direct sunlight, reflections and poor lighting",
    mainBenefitsnetwork4: "Casing protects the camera against the elements for outside surveillance",
    IdealUsesnetwork: "There are various CCTV camera types suited to outside use but the extra sensitive imaging of both day and night imaging modes makes this one camera type unique. It is therefore the ideal CCTV system for business premises that require around the clock CCTV monitoring in an outdoor environment with varying light conditions.",
    amenities8: "Day/Night CCTV Cameras",
