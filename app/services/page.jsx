...
const Services = () => {
  return (
    <>
        ...
        <div className="grid grid-cols-2 md:grid-cols-1 mt-[40px]">
          <div>
            ...
            <p className="absolute text-6xl w-[1000px] text-white top-1/2 left-[30px] -t ranslate-x-1/2 -translate-y-1/2 font-semibold shadow">
              Improve Your Business Efficiency With Our High Quality Solutions.
            </p>
          </div>
          <div className="mx-auto text-center">
            ...
            <p className="w-11/12 mx-auto py-16 text-xl md:w-[80%]">
              Our core value is the provision of affordable, professional and
              up-to-date digital I.T training skills that focuses on business
              need for both corporate organizations, governments and
              individuals.
            </p>
          </div>
        </div>
      ...
      <div className="w-[90%] mx-auto grid grid-cols-1 py-8 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10">
        {data
          .filter((services) => services.name !== "IT Training")
          .map((services) => (
            <ServiceCard
              services={services}
              first={false}
