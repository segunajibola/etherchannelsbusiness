...
import { CorporateCourses } from "../../../components";
...
const ParticularService = ({ params }) => {
  ...
  const newServiceName = serviceName.replace(/%20/g, " ");
  ...
  return (
    <div className="overflow-hidden dark:bg-gray-700">
      {services
        .filter((services) => services.name === newServiceName)
        .map((services) => (
          <div
            className="flex-shrink-0 pt-[80px] text-center"
            key={`${services.id}`}
          >
            ...
            {services.coursesHeading && (
              <div className="pb-10">
                ...
                <div className="grid grid-cols-3 gap-4 w-[80%] mx-auto">
                  {courses?.map((course) => (
                    <CorporateCourses course={course} key={`${course.id}`} />
                  ))}
                </div>
              </div>
            )}
              ...
              <div className="bg-gray-700">
                <div className="w-[90%] mx-auto">
                  <div className="bg-6" data-aos="zoom-in-right">
                    <div className="grid md:grid-cols-2 w-[95%] mx-auto mt-28 gap-x-4 py-10 px-12">
                      <img
